...
//        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.produk) {
            Intent intent = new Intent(DrawerActivity.this, MenuPakaianClient.class);
            startActivity(intent);
        } else if (id == R.id.cart) {
            Intent intent = new Intent(DrawerActivity.this, CartActivity.class);
            startActivity(intent);
        } else if (id == R.id.tentangkami) {
            Intent intent = new Intent(DrawerActivity.this, TentangKami.class);
            startActivity(intent);
        } else if (id == R.id.kontak) {
            Intent intent = new Intent(DrawerActivity.this, Kontak.class);
            startActivity(intent);
